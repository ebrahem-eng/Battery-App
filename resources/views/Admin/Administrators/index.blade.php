                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="card-title">
                            <a type="button" href="{{ route('admin.create.administrators') }}">
                                        ...
                                        @foreach ($administrators as $administrator)
                                            <tr style="font-size: 22px">
                                                ...
                                                <td class="text-center"><a
                                                        href="{{ route('admin.edit.administrators', $administrator->id) }}">
                                                ...
                                                <td>
                                                    <form action="{{route('admin.softdelete.administrators' , $administrator->id )}}" method="POST">
                                                        @csrf
                                                        @method('delete')
                                                        <button type="submit">
